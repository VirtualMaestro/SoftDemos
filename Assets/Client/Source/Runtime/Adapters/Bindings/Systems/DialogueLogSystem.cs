...
namespace Game.Adapters.Bindings
{
        ...
        IEcsInject<EcsWorld>, IEcsInject<ILog>
    {
        ...
        public DialogueLogSystem(AvatarImageRouterService avatars, TweenPlayer tweens,
            DialogueLogChannel channel)
        {
            _avatars = avatars;
            _tweens = tweens;
            _channel = channel;
        ...
        public int ViewCount => _bindings.Count;
        ...
        private void _SpawnVisibleLines()
        {
            ...
            foreach (var entityId in _world.Where(out VisibleLineAspect aspect))
