...
namespace Client.Simulation.PhoenixFlame.Systems
{
    ...
    /// is already running.
    /// </summary>
    internal sealed class FlamePhaseRequestSimSystem : IEcsSim, IEcsInject<EcsWorld>, IEcsInject<ILogService>
    {
        ...
        public void Sim()
        {
            ...
            // FlameClnSystem ends it, so a held button cannot build a backlog that fires the
