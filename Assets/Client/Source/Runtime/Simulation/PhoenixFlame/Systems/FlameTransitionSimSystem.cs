...
namespace Client.Simulation.PhoenixFlame.Systems
{
    ...
    /// </summary>
    internal sealed class FlameTransitionSimSystem : IEcsSim, IEcsInject<EcsWorld>,
        IEcsInject<ITimeService>
    {
        ...
        public void Sim()
        {
            ...
            // or non-finite duration, and FlameSetupSimSystem is the only writer — it copies the config
        ...
        {
            // The overshoot is dropped on purpose. CardCadenceSimSystem carries its remainder because
