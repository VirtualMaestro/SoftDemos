...
namespace Client.Simulation.PhoenixFlame.Systems
{
    ...
    /// <see cref="FlamePhaseRequestSystem"/> reads it and ignores it while a transition runs, and
    ...
    /// </remarks>
    internal sealed class FlameCleanupSystem : IEcsCleanup, IEcsInject<EcsWorld>
    {
