...
namespace Client.Simulation.Core.Navigation.Systems
{
    ...
    /// </summary>
    internal sealed class NavigationSimSystem : IEcsSim, IEcsInject<EcsWorld>,
        IEcsInject<ISceneService>, IEcsInject<ILogService>
    {
        ...
        public NavigationSimSystem(DemoCatalog catalog)
        {
            _catalog = catalog;
        }
        ...
        private void _ConsumeCloseCommands(ref ScreenStateComp state)
        {
            ...
            // it is NavigationClnSystem. Iterating still matters — a second command in the same
